...
class GetSkuCollection extends \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['page', 'pageSize', 'paginationMode', 'filter[skuCodes]', 'filter[skuGroupIds]', 'filter[active]']);
        ...
        $optionsResolver->addAllowedTypes('filter[skuCodes]', ['string']);
        $optionsResolver->addAllowedTypes('filter[skuGroupIds]', ['string']);
        $optionsResolver->addAllowedTypes('filter[active]', ['bool']);
     ...
     *
     * @return \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\SkuResourceCollection|\Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\ErrorResponse
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos(strtolower($contentType), 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\SkuResourceCollection', 'json');
        }
