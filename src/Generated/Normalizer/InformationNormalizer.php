...
class InformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\Information::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\Information::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\Information();
        ...
        if (\array_key_exists('references', $data)) {
            ...
            foreach ($data['references'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\ErrorReferencesItem::class, 'json', $context);
            }
    ...
    {
        return [\Datenkraft\Backbone\Client\SkuCatalogApi\Generated\Model\Information::class => false];
    }
}